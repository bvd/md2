...
class Pmupload extends CI_Controller {
	...
	private function findScaleMode(){
		...
		if(isset($this->dimensions->height)&&isset($this->dimensions->width)){
			// er kan sprake zijn van ��n (horizontaal of verticaal) voorgeschreven dimensie, of beide
			// ingeval van ��n, mag de andere een regexp zijn met een marge, waarbij in het algemeen geldt, tot 2000
